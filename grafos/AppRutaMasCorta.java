...
public class AppRutaMasCorta {
    ...
    public static void main(String[] args) throws GrafoException {
        ...
        graph.mejorRecorridoTiempo(1, 10);
    }
    ...
    public static Grafo crearGrafo() {
        ...
        graph.AddArista(1, 2, new DatosA(3));
        graph.AddArista(1, 3, new DatosA(6));
        graph.AddArista(1, 4, new DatosA(4));
        graph.AddArista(2, 5, new DatosA(2));
        graph.AddArista(3, 5, new DatosA(3));
        graph.AddArista(3, 8, new DatosA(1));
        graph.AddArista(3, 6, new DatosA(7));
        graph.AddArista(4, 6, new DatosA(3));
        graph.AddArista(4, 9, new DatosA(6));
        graph.AddArista(5, 7, new DatosA(5));
        graph.AddArista(5, 8, new DatosA(6));
        graph.AddArista(6, 8, new DatosA(8));
        graph.AddArista(6, 9, new DatosA(2));
        graph.AddArista(7, 2, new DatosA(4));
        graph.AddArista(7, 10, new DatosA(2));
        graph.AddArista(8, 10, new DatosA(4));
        graph.AddArista(8, 9, new DatosA(1));
        graph.AddArista(9, 10, new DatosA(3));
